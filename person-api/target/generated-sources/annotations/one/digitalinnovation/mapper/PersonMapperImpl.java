...
import one.digitalinnovation.dto.request.PersonDTO.PersonDTOBuilder;
import one.digitalinnovation.dto.request.PhoneDTO;
import one.digitalinnovation.dto.request.PhoneDTO.PhoneDTOBuilder;
import one.digitalinnovation.entity.Person;
import one.digitalinnovation.entity.Person.PersonBuilder;
import one.digitalinnovation.entity.Phone;
import one.digitalinnovation.entity.Phone.PhoneBuilder;

@Generated(
    value = "org.mapstruct.ap.MappingProcessor",
    date = "2020-10-22T20:19:43-0300",
    comments = "version: 1.4.1.Final, compiler: Eclipse JDT (IDE) 1.3.1150.v20200916-0836_JAVA15_PATCH, environment: Java 15 (Oracle Corporation)"
)
